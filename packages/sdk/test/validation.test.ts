...
import { ValidationUtils, TypeGuards } from '@sdk/utils/validation';
...
describe('ValidationUtils', () => {
  describe('validateAddress', () => {
    ...
    it('should reject invalid addresses', () => {
      ...
      invalidAddresses.forEach(address => {
        expect(() => ValidationUtils.isAddress(address))
  ...
  describe('validateHexString', () => {
    ...
    it('should reject invalid hex strings', () => {
      ...
      invalidHexStrings.forEach(hex => {
        expect(() => ValidationUtils.isHexString(hex))
          .toThrow(ValidationError);
      });
    });
  });
  ...
  describe('validateBytes32', () => {
    ...
    it('should reject invalid 32-byte hex strings', () => {
      ...
      invalidBytes32.forEach(bytes => {
        expect(() => ValidationUtils.isValidBytes32(bytes))
          .toThrow(ValidationError);
      });
    });
  });
  ...
  describe('validateRequired', () => {
    it('should accept non-null/undefined values', () => {
      ...
      validValues.forEach(value => {
        expect(() => ValidationUtils.validateRequired(value, 'testField'))
          .not.toThrow();
      });
    });
  ...
  describe('validateNumberRange', () => {
    ...
    it('should reject numbers outside range', () => {
      expect(() => ValidationUtils.validateNumberRange(0, 1, 10))
        .toThrow(ValidationError);
      expect(() => ValidationUtils.validateNumberRange(11, 1, 10))
        .toThrow(ValidationError);
    });

    it('should reject non-numbers', () => {
      expect(() => ValidationUtils.validateNumberRange('5', 1, 10))
        .toThrow(ValidationError);
      expect(() => ValidationUtils.validateNumberRange(null, 1, 10))
        .toThrow(ValidationError);
    });

    it('should reject infinite numbers', () => {
      expect(() => ValidationUtils.validateNumberRange(Infinity, 1, 10))
        .toThrow(ValidationError);
      expect(() => ValidationUtils.validateNumberRange(NaN, 1, 10))
        .toThrow(ValidationError);
    });
  });
  ...
  describe('validatePositiveInteger', () => {
    it('should accept positive integers', () => {
      ...
      validValues.forEach(value => {
        expect(() => ValidationUtils.validatePositiveInteger(value))
          .not.toThrow();
      });
    });
  ...
  describe('validateNonNegativeInteger', () => {
    it('should accept non-negative integers', () => {
      ...
      validValues.forEach(value => {
        expect(() => ValidationUtils.validateNonNegativeInteger(value))
          .not.toThrow();
      });
    });
  ...
  describe('validateMinArrayLength', () => {
    it('should accept arrays with sufficient length', () => {
      expect(() => ValidationUtils.validateMinArrayLength([1, 2, 3], 2))
        .not.toThrow();
      expect(() => ValidationUtils.validateMinArrayLength([1, 2], 2))
        .not.toThrow();
    });

    it('should reject arrays that are too short', () => {
      expect(() => ValidationUtils.validateMinArrayLength([1], 2))
        .toThrow(ValidationError);
      expect(() => ValidationUtils.validateMinArrayLength([], 1))
        .toThrow(ValidationError);
    });

    it('should reject non-arrays', () => {
      expect(() => ValidationUtils.validateMinArrayLength('not array', 1))
        .toThrow(ValidationError);
    });
  });
  ...
  describe('validateGasAmount', () => {
    it('should validate reasonable gas amounts', () => {
      ...
      validGasAmounts.forEach(gas => {
        expect(() => ValidationUtils.validateGasAmount(gas))
          .not.toThrow();
      });
    });
  ...
  describe('validateWeiAmount', () => {
    it('should validate wei amounts', () => {
      ...
      validWeiAmounts.forEach(wei => {
        expect(() => ValidationUtils.validateWeiAmount(wei))
          .not.toThrow();
      });
    });

    it('should reject invalid wei amounts', () => {
      expect(() => ValidationUtils.validateWeiAmount('invalid'))
        .toThrow(ValidationError);
    });
  });
  ...
  describe('validateTimeout', () => {
    it('should validate reasonable timeout values', () => {
      ...
      validTimeouts.forEach(timeout => {
        expect(() => ValidationUtils.validateTimeout(timeout))
          .not.toThrow();
      });
    });
