  ...
  describe('number conversions', () => {
    describe('bigintToHexNumber', () => {
      it('should convert bigint to hex number', () => {
        ...
        expect(bigintToHexNumber(1000000000000000000n)).toBe('0xde0b6b3a7640000');
      });
    });
    ...
    describe('hexNumberToBigint', () => {
      it('should convert hex number to bigint', () => {
        ...
        expect(hexNumberToBigint('0xde0b6b3a7640000' as any)).toBe(1000000000000000000n);
      });
    });
    ...
    describe('hexNumberToNumber', () => {
      ...
      it('should throw for numbers too large for safe integer', () => {
        expect(() => hexNumberToNumber('0x20000000000000' as any)).toThrow(ValidationError);
      });
    });
  });
  ...
  describe('GasUtils', () => {
    ...
    describe('subtract', () => {
      ...
      it('should throw for negative results', () => {
        expect(() => GasUtils.subtract('0x5208' as any, '0xa410' as any))
    ...
    describe('calculatePercentage', () => {
      it('should calculate gas percentage', () => {
        const percentage = GasUtils.calculatePercentage('0x5208' as any, '0xa410' as any);
        expect(percentage).toBe(50); // 21000 / 42000 = 50%
      });

      it('should handle zero gas limit', () => {
        const percentage = GasUtils.calculatePercentage('0x5208' as any, '0x0' as any);
