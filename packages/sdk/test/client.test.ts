...
describe('AltitraceClient', () => {
  ...
  describe('executeSimulation', () => {
    ...
    it('should validate simulation request', async () => {
      ...
      expect(client.executeSimulation(invalidRequest)).rejects.toThrow(
        ValidationError,
      )
    })
  })
  ...
  describe('simulateBatch', () => {
    ...
    it('should validate batch configuration', async () => {
      ...
      expect(client.simulateBatch(invalidConfig)).rejects.toThrow(
        ValidationError,
      )
    })
  ...
  describe('healthCheck', () => {
    ...
    it('should handle health check errors', async () => {
      ...
      await expect(client.healthCheck()).rejects.toThrow(AltitraceApiError)
    })
  })
